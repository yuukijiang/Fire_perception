...
input_size = 3  #x的特征维度
hidden_size = 12    #隐藏层的特征维度
num_layers = 2  #lstm隐层的层数，默认为1
output_size = 3
model = lstm.lstm(input_size, hidden_size, num_layers,output_size)
# para = summary(model, (20,3))
# para = stat(model, (20, 3))
# print(para)
if args.cuda:
...
#                       而且梯度变大意味着学习收敛速度快，能大大加快训练速度。
    ...
    print('Train Epoch:{}\tmean_loss:{}'.format(ep,epoch_loss / (length_train * batch_size)))
...
if __name__ == "__main__":
    for epoch in range(1, epochs + 1):
        ...
        print(test_time_str)
        if epoch == 30:
            with open('E:\\fire_detection\\tcn\pth\\lstm_result.txt', 'w') as f:
